...
public class FilterResultsFragment extends DialogFragment {
    ...
    private void createFilter(final FilterDescription filter) {
        ...
        final View filterLayout = getInflatedLayout(isSeekBar ? com.algolia.instantsearch.R.layout.layout_seekbar : com.algolia.instantsearch.R.layout.layout_checkbox);
        ...
        if (isSeekBar) {
            ...
            final TextView tv = (TextView) filterLayout.findViewById(com.algolia.instantsearch.R.id.dialog_seekbar_text);
            final SeekBar seekBar = (SeekBar) filterLayout.findViewById(com.algolia.instantsearch.R.id.dialog_seekbar_bar);
            ...
            final TextView tv = (TextView) filterLayout.findViewById(com.algolia.instantsearch.R.id.dialog_checkbox_text);
            final CheckBox checkBox = (CheckBox) filterLayout.findViewById(com.algolia.instantsearch.R.id.dialog_checkbox_box);
